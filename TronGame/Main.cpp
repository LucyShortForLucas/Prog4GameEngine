...
namespace {
static inline bool what_the_fuck_vld = [] {
	VLDDisable();
...
int main(int, char*[]) {
	...
	eng::Engine engine{ "Tron - Battle Tanks - Lucas Schonkeren", 968, 1008 };


#ifdef NDEBUG
	eng::service::logger.Register(std::make_unique<eng::MessageBoxLogger>(*engine.GetWindowPtr()));
#endif
